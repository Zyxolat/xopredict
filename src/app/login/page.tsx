      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center py-8">
        ...
        <div className="w-full max-w-[480px] px-5 flex flex-col items-center">
          ...
          <div className="w-full space-y-3 mb-8 stagger-2">
            ...
            <div className="relative w-full min-h-14 rounded-xl bg-primary text-on-primary neon-glow flex items-center justify-center">
              <ConnectButton />
            </div>

            {/* Google and Email options — only rendered when no session is active */}
