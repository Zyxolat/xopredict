...
type NotificationPrefs = {
  notifyMatchSettlement: boolean;
  notifySecurityAlerts: boolean;
  notifyPromotions: boolean;
};

const ITEMS: { key: keyof NotificationPrefs; label: string }[] = [
  { key: "notifyMatchSettlement", label: "Match & Arena Settlements" },
  { key: "notifySecurityAlerts", label: "Security & Login Alerts" },
  { key: "notifyPromotions", label: "Season Leaderboard & VIP Updates" },
];
